                                        ...
                                        <div className="flex items-center justify-between mt-4 pt-4 border-t border-slate-50 relative">
                                            ...
                                            <div className="flex gap-2 relative z-[9999] pointer-events-auto">
                                                <button 
                                                    ...
                                                    className="p-2 bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200 cursor-pointer active:scale-95 transition-all shadow-sm"
                                                ...
                                                <button 
                                                    ...
                                                    className="p-2 bg-red-100 text-red-700 rounded-lg hover:bg-red-200 cursor-pointer active:scale-95 transition-all shadow-sm"
                                                    style={{ position: 'relative', zIndex: 10000 }}
                                                >
