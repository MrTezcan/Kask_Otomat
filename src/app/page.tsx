        ...
        <main className="flex min-h-screen flex-col items-center justify-center p-6 relative overflow-hidden">
            ...
            <div className="glass-card w-full max-w-md p-8 rounded-2xl relative z-10 animate-fade-in">
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                    ...
                    {error && (
                        <div className={`p-3 text-sm rounded-lg border backdrop-blur-md ${error.includes('başarılı') ? 'text-green-300 bg-green-900/40 border-green-500/30' : 'text-red-300 bg-red-900/40 border-red-500/30'}`}>
                            {error}
                        </div>
                    )}
                    ...
                    <div className="flex items-center justify-between text-sm">
                        <label className="flex items-center gap-2 cursor-pointer group">
                            ...
                            />
                            <span className="text-slate-500 group-hover:text-slate-600 transition-colors">Beni Hatırla</span>
                        </label>
