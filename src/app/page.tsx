...
export default function Home() {
    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-center p-6 relative overflow-hidden">
            ...
            {/* Arkaplan Efektleri (Y�zen K�reler) */}
            ...
            <div className="glass-card w-full max-w-md p-8 rounded-2xl relative z-10 animate-fade-in">
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                    ...
                    {error && (
                        <div className={`p-3 text-sm rounded-lg border backdrop-blur-md ${error.includes('ba�ar�l�') ? 'text-green-300 bg-green-900/40 border-green-500/30' : 'text-red-300 bg-red-900/40 border-red-500/30'}`}>
                            {error}
                        </div>
                    )}
                    ...
                    <div className="flex items-center justify-between text-sm">
                        <label className="flex items-center gap-2 cursor-pointer group">
                            ...
                            />
                            <span className="text-slate-500 group-hover:text-slate-600 transition-colors">Beni Hat�rla</span>
                        </label>
                        <a href="#" className="text-brand-primary hover:text-brand-accent transition-colors">�ifremi Unuttum</a>
                    </div>
                    ...
                    <div className="space-y-3 pt-2">
                        ...
                        >
                            {loading ? (
                                ...
                                <>Giri� Yap <ArrowRight className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" /></>
                            )}
                        </button>
                        ...
                        >
                            Hesab�n�z yok mu? <span className="text-brand-accent">Kay�t Olun</span>
                        </button>
                    </div>
                </form>
            ...
            <footer className="absolute bottom-4 text-center text-slate-600 text-[10px]">
                &copy; 2026 Fresh-Rider Hygiene Systems. T�m haklar� sakl�d�r.
            </footer>
        </main>
    )
}
