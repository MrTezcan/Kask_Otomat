...
// Replace 2: QrScannerComponent onScan Logic
...
const newScanner = onScan={(text) => {
                                    ...
                                    // Parse freshrider URI scheme from Tablet Kiosk
...
// Replace 3: handleQrPayment Logic Update
...
// Replace 4: Render UI Payment Modal text fixes
...
const newModalUI = <div className="w-full p-4 bg-slate-50 rounded-2xl border border-slate-100 space-y-2">
                                <div className="flex justify-between text-sm">
                                    <span className="text-slate-500">
                                        {kioskPayload ? (kioskPayload.perfume ? 'Parfümlü Temizlik' : 'Standart Temizlik') : 'Hizmet Ucreti'}
                                    </span>
